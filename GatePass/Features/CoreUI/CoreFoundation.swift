...
enum CoreTypography {
    static let pageTitle = CoreTextStyle(
        size: 24,
        weight: .semibold,
        nsWeight: .semibold,
        lineHeight: 30,
    ...
    static let sectionTitle = CoreTextStyle(
        size: 16,
        weight: .semibold,
        nsWeight: .semibold,
        lineHeight: 22,
    ...
    static let control = CoreTextStyle(
        size: 14,
        weight: .medium,
        nsWeight: .medium,
        lineHeight: 18,
    ...
    static let caption = CoreTextStyle(
        size: 12,
        weight: .regular,
        nsWeight: .regular,
        lineHeight: 16,
    ...
    static let groupLabel = CoreTextStyle(
        size: 12,
        weight: .medium,
        nsWeight: .medium,
        lineHeight: 16,
    ...
    static let brand = CoreTextStyle(
        size: 16,
        weight: .semibold,
        nsWeight: .semibold,
        lineHeight: 20,
