...
struct CoreSidebarButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .background(
                isSelected ? CoreColor.selectionBackground : Color.clear,
            ...
            .overlay {
                if isFocused {
                    RoundedRectangle(cornerRadius: cornerRadius, style: .continuous)
                        .stroke(CoreColor.focusRing, lineWidth: CoreMetrics.focusRingWidth)
                        .padding(-CoreMetrics.focusRingOffset)
                }
            }
    ...
    var body: some View {
        Button(action: action) {
            ...
            .overlay {
                Capsule()
                    .stroke(
                        isSelected ? CoreColor.focusRing : CoreColor.border,
